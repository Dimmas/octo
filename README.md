...
5. Индексирование хостов
    ...
    Для запуска индексирования выполните: # python3 octo.py index, или    # python3 octo.py , а затем пункт 4/ (В планировщике cron каждого хоста добавлено задание на индексацию каждый день в 13.00)
